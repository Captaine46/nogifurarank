...
既有 `summary.json` 可直接產生四張 TOP50 圖與一張新登場注目卡比較圖，
不會重新訪問 API：
...
第五張 `x-new-focus-6months-5pct.png` 以排名快照的日本時間為基準，列出
初回登場六個月內、且「お見立て会 TOP20／個人ランキング TOP75 ×
防衛／攻撃」四區分任一編成採用率達 5% 的メンバーカード。這裡是編成採用率，
